...
/* Just for task0 */
/**
 * struct converter_s0 - A new type defining a converter struct.
 * @specifier: A character representing a conversion specifier.
 * @func: A pointer to a conversion function corresponding to specifier.
 */
typedef struct converter_s0
{
	unsigned char specifier;
	unsigned int (*func)(va_list, buffer_t *);
} converter_t0;

unsigned int convert_c0(va_list ap, buffer_t *output);
unsigned int convert_s0(va_list ap, buffer_t *output);
